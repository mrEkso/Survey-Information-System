package com.oss.api.exceptions.handlers;
...
import com.oss.api.exceptions.models.ErrorDetail;
import com.oss.api.exceptions.models.ErrorResponse;
import com.oss.api.exceptions.models.ErrorValidationResponse;
...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleAccessDeniedException(AccessDeniedException ex) {
        ...
        return new ErrorResponse(
                ...
                ex.getClass().getSimpleName(),
                "Доступ заборонено: у вас недостатньо прав для виконання цієї операції");
    }
    ...
    public ErrorResponse handleIllegalArgumentException(IllegalArgumentException ex) {
        ...
        return new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getClass().getSimpleName(),
                ex.getMessage() != null ? ex.getMessage() : "Невірні параметри запиту");
    }
